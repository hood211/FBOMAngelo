...
Fig2a <- ggplot(fbomB, aes(y = 10^(gAFDMm2), x = 10^logWA, fill = stream)) +
  ...
  xlab(NULL) +
  ylab(expression(atop("Benthic POM stock", paste("(g AFDM ",m^-2,")")))) +
  scale_x_log10() +
  scale_y_log10() +
...
FigS4 <-ggplot() +
  ...
  xlab(expression(paste("Watershed area (", km^2, ")"))) +
  ylab("Percent of bulk benthic POM") +
               # ylim(0,1.1) +
...
P.Stock.Bac <- fbomBStockFigs$plot[[2]] +
  ylab(expression(atop("Bacterial density", paste("(",10^9," ", m^-2,")")))) +
...
P.Stock.micN <- fbomBStockFigs$plot[[1]] +
  ylab(expression(atop("Microbial biomass", paste("(mg N ",m^-2,")")))) +
  scale_y_log10() +
...
Fig2b.g <- ggplotGrob(P.Stock.micN)
Fig2c.g <- ggplotGrob(P.Stock.Bac)
...
Fig2.gtf <- gtable_frame(gtable_rbind(Fig2a.gtf, Fig2b.gtf, Fig2c.gtf),  width = unit(1, "null"), height = unit(3, "null"))
...
pdf(file.path(here::here("03_plots"), "Fig2.pdf"), height = 15, width =7)
  ...
  grid.text("(b)", x = unit(0.04,"npc"), y = unit(0.65,"npc"), gp=gpar(fontsize = 25))
  grid.text("(c)", x = unit(0.04,"npc"), y = unit(0.33,"npc"), gp=gpar(fontsize = 25))
dev.off()
...
```{r}
Fig6a.g <- ggplotGrob(P.Eco.Nup)
Fig6b.g <- ggplotGrob(P.Eco.Pup)
Fig6c.g <- ggplotGrob(P.Eco.R)

Fig6a.gtf <- gtable_frame(Fig6a.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig6b.gtf <- gtable_frame(Fig6b.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig6c.gtf <- gtable_frame(Fig6c.g,  width = unit(1, "null"), height = unit(1, "null"))

Fig6.gtf <- gtable_frame(gtable_rbind(Fig6a.gtf, Fig6b.gtf, Fig6c.gtf),  width = unit(1, "null"), height = unit(3, "null"))

pdf(file.path(here::here("03_plots"), "Fig6.pdf"), height = 15, width =7)
  grid.newpage()
  grid.draw(Fig6.gtf)
  grid.text("(a)", x = unit(0.06,"npc"), y = unit(0.98,"npc"), gp=gpar(fontsize = 25))
  grid.text("(b)", x = unit(0.06,"npc"), y = unit(0.65,"npc"), gp=gpar(fontsize = 25))
  grid.text("(c)", x = unit(0.06,"npc"), y = unit(0.33,"npc"), gp=gpar(fontsize = 25))
dev.off()
...
P.Act.Nup.afdm <- fbomBRateFigsAFDM$plot[[1]] +
  ylab(expression(atop("Mass-specific N uptake", paste("(µg N g ", AFDM^-1," ", h^-1,")")))) +
  scale_y_log10(labels = fancy_scientific) +
  theme(legend.position = c(0.025,1),
        legend.background = element_rect(fill = "transparent"),
...
P.Act.Pup.afdm <- fbomBRateFigsAFDM$plot[[2]] +
  ylab(expression(atop("Mass-specific P uptake", paste("(µg P g ", AFDM^-1," ", h^-1,")")))) +
  scale_y_log10(labels = fancy_scientific) +
...
P.Act.R.afdm <- fbomBRateFigsAFDM$plot[[3]] +
  ylab(expression(atop("Mass-specific respiration", paste("(mg DO g ", AFDM^-1," ", h^-1,")")))) +
  scale_y_log10(labels = fancy_scientific) +
...
```{r eval=FALSE, include=FALSE}
Fig5a.g <- ggplotGrob(P.Act.Nup.afdm)
Fig5b.g <- ggplotGrob(P.Act.Pup.afdm)
Fig5c.g <- ggplotGrob(P.Act.R.afdm)
Fig5d.g <- ggplotGrob(P.Act.Nup.N)
Fig5e.g <- ggplotGrob(P.Act.Pup.N)
Fig5f.g <- ggplotGrob(P.Act.R.N)

Fig5a.gtf <- gtable_frame(Fig5a.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig5b.gtf <- gtable_frame(Fig5b.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig5c.gtf <- gtable_frame(Fig5c.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig5d.gtf <- gtable_frame(Fig5d.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig5e.gtf <- gtable_frame(Fig5e.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig5f.gtf <- gtable_frame(Fig5f.g,  width = unit(1, "null"), height = unit(1, "null"))

Fig5abc.gtf <- gtable_frame(gtable_cbind(Fig5a.gtf, Fig5b.gtf, Fig5c.gtf),  width = unit(1, "null"), height = unit(2, "null"))
Fig5def.gtf <- gtable_frame(gtable_cbind(Fig5d.gtf, Fig5e.gtf, Fig5f.gtf),  width = unit(1, "null"), height = unit(2, "null"))
Fig5.gtf <- gtable_frame(gtable_rbind(Fig5abc.gtf, Fig5def.gtf))

pdf(file.path(here::here("03_plots"), "Fig5.pdf"), height = 15, width = 27)
  grid.newpage()
  grid.draw(Fig5.gtf)
  grid.text("(a)", x = unit(0.015,"npc"), y = unit(0.99,"npc"), gp=gpar(fontsize = 32))
  grid.text("(b)", x = unit(0.35,"npc"), y = unit(0.99,"npc"), gp=gpar(fontsize = 32))
  grid.text("(c)", x = unit(0.68,"npc"), y = unit(0.99,"npc"), gp=gpar(fontsize = 32))
  grid.text("(d)", x = unit(0.015,"npc"), y = unit(0.49,"npc"), gp=gpar(fontsize = 32))
  grid.text("(e)", x = unit(0.35,"npc"), y = unit(0.49,"npc"), gp=gpar(fontsize = 32))
  grid.text("(f)", x = unit(0.68,"npc"), y = unit(0.49,"npc"), gp=gpar(fontsize = 32))
dev.off()
...
Fig3A <- ggplot() +
  ...
  annotate("text", x = -1.5, y = 1.9, label = "Bulk fraction", size = 10, hjust = 0)
```
...
Fig3B <-ggplot() +
  ...
  annotate("text", x = -1.5, y = 1.4, label = "Size fractions", size = 10, hjust = 0) 
```
...
Fig3C <- ggplot() +
  ...
  theme(panel.background = element_rect(fill = "transparent", color = "black", size = 1.25),
        ...
        legend.title = element_blank(),
        legend.key = element_rect(fill = "transparent")) +
  annotate("text", x = -2.5, y = 2.4, label = "Activity rates", size = 10, hjust = 0) 
```
...
Fig3D <-ggplot() +
  ...
  theme(panel.background = element_rect(fill = "transparent", color = "black", size = 1.25),
        ...
        legend.title = element_blank(),
        legend.key = element_rect(fill = "transparent")) +
  annotate("text", x = -1, y = 1, label = "Areal uptake & respiration", size = 10, hjust = 0)
...
Fig3d.g <- ggplotGrob(Fig3D)

Fig3a.gtf <- gtable_frame(Fig3a.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig3b.gtf <- gtable_frame(Fig3b.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig3c.gtf <- gtable_frame(Fig3c.g,  width = unit(1, "null"), height = unit(1, "null"))
Fig3d.gtf <- gtable_frame(Fig3d.g,  width = unit(1, "null"), height = unit(1, "null"))

Fig3ab.gtf <- gtable_frame(gtable_cbind(Fig3a.gtf, Fig3b.gtf),  width = unit(1, "null"), height = unit(2, "null"))
Fig3cd.gtf <- gtable_frame(gtable_cbind(Fig3c.gtf, Fig3d.gtf),  width = unit(1, "null"), height = unit(2, "null"))
Fig3.gtf <- gtable_frame(gtable_rbind(Fig3ab.gtf, Fig3cd.gtf))

pdf(file.path(here::here("03_plots"), "Fig3.pdf"), height = 12, width = 16)
  grid.newpage()
  grid.draw(Fig3.gtf)
  grid.text("(a)", x = unit(0.015,"npc"), y = unit(0.98,"npc"), gp=gpar(fontsize = 25))
  grid.text("(b)", x = unit(0.515,"npc"), y = unit(0.98,"npc"), gp=gpar(fontsize = 25))
  grid.text("(c)", x = unit(0.015,"npc"), y = unit(0.48,"npc"), gp=gpar(fontsize = 25))
  grid.text("(d)", x = unit(0.515,"npc"), y = unit(0.48,"npc"), gp=gpar(fontsize = 25))
dev.off()
...
```{r}
 FigS9A <- ggplot(fbomSes, aes(y = F_CN, x = S_CN, fill = siteName)) +
    ...
    xlim(0,35) +
    ylim(0,35) +
    ylab("Benthic POM C:N") +
    xlab("Suspended POM C:N") +
...
```{r}
  FigS9B <- ggplot(fbomSes, aes(y = F_13C, x = S_13C, fill = siteName)) +
    geom_point(shape = 21, alpha = 75/100, size = 7) +
    geom_abline(intercept = 0, slope = 1)+
    ylab(expression(paste("Benthic POM ",delta^13,"C (‰)"))) +
    xlab(expression(paste("Suspended POM ",delta^13,"C (‰)"))) +
    xlim(-30,-20) +
    ylim(-30,-20)+
...
```{r}
  FigS9C <- ggplot(fbomSes, aes(y = F_15N, x = S_15N, fill = siteName)) +
    geom_point(shape = 21, alpha = 75/100, size = 7) +
    geom_abline(intercept = 0, slope = 1)+
    ylab(expression(paste("Benthic POM ",delta^15,"N (‰)"))) +
    xlab(expression(paste("Suspended POM ",delta^15,"N (‰)"))) +
    xlim(-1,4) +
    ylim(-1,4)+
